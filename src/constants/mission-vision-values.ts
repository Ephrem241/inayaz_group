...
export const MEANING_OF_INAYAZ =
  "INAYAZ (ኢናያ / عناية) means care, concern, attention, protection, kindness, and solicitude. INAYAZ represents care, precision, and responsibility. It reflects our commitment to protecting client interests, paying attention to every detail, and delivering every project with integrity and excellence.";
...
export const CORE_VALUES: CoreValue[] = [
  { id: "integrity", number: "01", name: "Integrity" },
  { id: "quality-excellence", number: "02", name: "Quality Excellence" },
  { id: "innovation", number: "03", name: "Innovation" },
  { id: "professionalism", number: "04", name: "Professionalism" },
  { id: "safety-first", number: "05", name: "Safety First" },
];
